  ...
  return (
    ...
    >
      ...
      {userDuplicates.length > 0 && (
        <div className="mb-4 bg-alert-warning-background rounded-lg p-4 border border-primary/20">
          {exactDuplicates.length > 0 && (
            <div className="flex items-start gap-2 bg-alert-error-text">
          ...
          {partialDuplicates.length > 0 && (
            <div className="flex items-start gap-2 bg-alert-warning-text mt-3">
