      ...
      <div className="bg-white rounded-lg w-full max-w-md">
        <div className="p-4 border-b flex justify-between items-center">
          <h2 className="text-lg font-semibold">
            {multipleUsers && multipleUsers.length > 0 
              ? `Enviar Mensaje a ${multipleUsers.length} Usuarios`
        ...
        {multipleUsers && multipleUsers.length > 0 && (
          <div className="p-4 bg-blue-50 border-b">
            <p className="text-sm text-blue-700 font-medium">Enviando a:</p>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {scrapedItem.price && (
                    <p className="text-sm text-gray-600">Precio: €{scrapedItem.price}</p>
                  )}
                  {scrapedItem.color && (
